...
.getQueryLen <- getterConstructor('query_len', 'query', 'query_id')
...
.getHitLen <- getterConstructor('length', 'hit', 'query_id')
...
.getGeneID <- getterConstructor('gene_id', 'hit', 'query_id')
...
.getHspHitID <- getterConstructor('hit_id', 'hsp', 'query_id')
...
.getBitscore <- getterConstructor('bit_score', 'hsp', 'query_id')
#' @rdname Bitscore-methods
#' @aliases getBitscore,blastReportDB-method
setMethod("getBitscore", "blastReportDB", function (x, id, max = FALSE) {
  .getBitscore(x, id)
})
#' @rdname Bitscore-methods
#' @aliases getMaxBitscore,blastReportDB-method
setMethod("getMaxBitscore", "blastReportDB", function (x, id) 'not implemented')
#' @rdname Bitscore-methods
#' @aliases getTotalBitscore,blastReportDB-method
setMethod("getTotalBitscore", "blastReportDB", function (x, id) 'not implemented')

.getScore <- getterConstructor('score', 'hsp', 'query_id')
#' @rdname Score-methods
#' @aliases getScore,blastReportDB-method
setMethod("getScore", "blastReportDB", function (x, id) .getScore(x, id))

.getEvalue <- getterConstructor('evalue', 'hsp', 'query_id')
#' @rdname Evalue-methods
#' @aliases getEvalue,blastReportDB-method
setMethod("getEvalue", "blastReportDB", function (x, id) .getEvalue(x, id))

.getQueryFrom <- getterConstructor('query_from', 'hsp', 'query_id')
...
.getQueryTo <- getterConstructor('query_to', 'hsp', 'query_id')
...
.getHitFrom <- getterConstructor('hit_from', 'hsp', 'query_id')
...
.getQueryTo <- getterConstructor('hit_to', 'hsp', 'query_id')
...
.getQueryFrame <- getterConstructor('query_frame', 'hsp', 'query_id')
...
.getHitFrame <- getterConstructor('hit_frame', 'hsp', 'query_id')
...
.getIdentity <- getterConstructor('identity', 'hsp', 'query_id')
#' @rdname Identity-methods
#' @aliases getIdentity,blastReportDB-method
setMethod("getIdentity", "blastReportDB", function (x, id) .getIdentity(x, id))

.getPositive <- getterConstructor('positive', 'hsp', 'query_id')
#' @rdname Positive-methods
#' @aliases getPositive,blastReportDB-method
setMethod("getPositive", "blastReportDB", function (x, id) .getPositive(x, id))

.getGaps <- getterConstructor('gaps', 'hsp', 'query_id')
#' @rdname Gaps-methods
#' @aliases getGaps,blastReportDB-method
setMethod("getGaps", "blastReportDB", function (x, id) .getGaps(x, id))

.getAlignLen <- getterConstructor('align_len', 'hsp', 'query_id')
...
setMethod("getMaxPercIdentity", "blastReportDB", function (x, id) 'not implemented')
